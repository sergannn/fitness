        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: DateTimeSelectorFormField(
                  ...
                  onSelect: (date) {
                    if (date.withoutTime.withoutTime
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text(
                            'Дата окончания наступает раньше даты начала.'),
                      ));
                    } else {
                      _endDate = date.withoutTime;
                  ...
                  validator: (value) {
                    if (value == null || value == "") {
                      return "Пожалуйста, выберите дату окончания.";
                    }
                    return null;
                  },
                  textStyle: TextStyle(
                ...
                child: DateTimeSelectorFormField(
                  ...
                  onSelect: (date) {
                    if (_startTime != null &&
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text('Время окончания меньше времени начала.'),
                      ));
                    } else {
                      _endTime = date;
                    }
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value == null || value.trim() == "") {
                return "Пожалуйста, введите описание события.";
              }
              return null;
            },
            decoration: AppConstants.inputDecoration.copyWith(
          ...
          if (_selectedRecurrenceEnd == RecurrenceEnd.onDate)
            DateTimeSelectorFormField(
              ...
              decoration: AppConstants.inputDecoration.copyWith(
                labelText: 'Заканчивается',
              ),
              onSelect: (date) {
                if (date.withoutTime.isBefore(_endDate.withoutTime)) {
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    content:
                        Text('Повторение заканчивается после даты окончания'),
                  ));
                } else {
          ...
          if (_selectedRecurrenceEnd == RecurrenceEnd.after)
            TextFormField(
              ...
              validator: (value) {
                if (value == null || value.trim() == '') {
                  return 'Пожалуйста, укажите количество повторений.';
                }
                return null;
              },
              decoration: AppConstants.inputDecoration.copyWith(
          ...
          CustomButton(
            onTap: _createEvent,
            title:
                widget.event == null ? "Добавить событие" : "Обновить событие",
          ),
        ],
      ),
    );
